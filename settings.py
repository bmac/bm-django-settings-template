...
ADMINS = (
    # TODO: Set admin username and email
     ('username', 'email@gmail.com'),
)

MANAGERS = ADMINS

# Databases is set up for sqlite 3 so I can get started quickly
DATABASES = {
    'default': {
...
#SECRET_KEY = 'TOFO: REMEMBER TO SET THIS'
